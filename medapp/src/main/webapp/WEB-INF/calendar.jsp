...
<head>
    ...
    <style>
        .has-appointment {
            background-color: blue; /* Color azul para las fechas con citas */
        ...
        <header class="d-flex justify-content-between align-items-center p-4 position-relative">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0">${doctor.availability}</p>
                    <p class="mb-0">de ${doctor.startTime} a ${doctor.endTime}</p>
                </div>
            </div>
            <img src="/img/logo2.png" alt="logoprincipal" class="logo position-absolute start-50 translate-middle-x p-2">
            <div>
                <a href="/logout" class="btn btn-custom">Cerrar Sesion</a>
                <a href="/patient/${userInSession.id}" class="btn btn-custom">Ir a mi perfil</a>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header text-white">
                    <h5 class="modal-title" id="appointmentModalLabel">Citas para el Día</h5>
                    <button type="button" class="btn-close btn-close-white" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="appointmentList">
                        <!-- Aquí se llenarán las citas del día seleccionado -->
                    </div>
                </div>
            </div>
        </div>
