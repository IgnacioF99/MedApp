  ...
  <div class="container-fluid">
    ...
    <main class="p-4">
      <section class="mb-4">
        ...
        <p class="m-2">
          Med App facilita la programaci�n de citas en l�nea, optimiza la administraci�n de turnos y centraliza los
          historiales m�dicos, permitiendo una experiencia m�s r�pida y sencilla tanto para pacientes como para el
          personal m�dico. <br>
          Con nuestro enfoque en la accesibilidad, la gesti�n eficiente y la simplificaci�n
          administrativa, Med App asegura una atenci�n m�dica m�s efectiva y organizada, reduciendo tiempos de espera y
          mejorando la coordinaci�n entre todos los involucrados en el cuidado de la salud.
        </p>
      </section>
      <section class="mb-5">
