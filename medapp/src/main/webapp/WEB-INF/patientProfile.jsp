			...
			<div class="card-body">
				<h1 class="text-center">
					...
					<div class="mb-4">
						...
						<p>
							<span>Obra Social:</span> ${user.insurance.name}
						</p>
					</div>
										...
										<div class="col-md-5">
											<div class="card card-turno">
												<div class="card-body">
													...
													<p class="card-text">
														Fecha: ${appointment.appointmentDate} <br> Hora:
														${appointment.appointmentTime} <br> Profesional:
														${appointment.doctor}
													</p>
													<form action="/cancelAppointment/${appointment.id}"
														method="post">
														<input type="hidden" name="turnoId"
															value="${appointment.id}"> <input type="submit"
															class="btn btn-custom btn-sm" value="Cancelar turno">
													</form>
												</div>
											</div>
										</div>
