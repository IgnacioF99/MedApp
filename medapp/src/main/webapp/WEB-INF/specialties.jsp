...
<body class="bg-light">
    <div class="container-custom d-flex flex-column container-fluid">
        ...
        <main class="d-flex flex-column align-items-center main-custom">
            ...
            <form:form action="/addSpecialty" method="POST" modelAttribute="newSpecialty" class="w-75 mt-3">
                <div class="row justify-content-center align-items-center mb-3">
                    <div class="col-auto">
                        <form:label class="inputLabel" path="firstName">Nueva Especialidad:</form:label>
                    </div>
                    <div class="col-auto">
                        ...
                        <c:forEach items="${specialties}" var="specialty">
                            <tr>
                                ...
                                <td class="text-center">
                                    <input type="delete" class="btn btn-custom btn-sm" value="Dar de baja">
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
